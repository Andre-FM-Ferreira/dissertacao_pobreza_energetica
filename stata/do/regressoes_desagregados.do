* =============================================================================
* Regressões com os dados desagregados
* =============================================================================
...
foreach d_var in "sim_mun" "sim_freg" {	
	regress `d_var' ippcc renda_med desemprego gini resid_estr esc_med_anos dens_pop sobrelot agreg_2 agreg_3 agreg_4 agreg_5 agreg_6 agreg_7 agreg_8 agreg_9_mais temp_med temp_amp lig_nec_rep med_nec_rep prof_nec_rep aloj_x_1919 aloj_1919_1945 aloj_1946_1960 aloj_1961_1980 aloj_1981_1990 aloj_1991_2000 aloj_2001_2005 aloj_2006_2010 aloj_2011_2015 propriet_c_enc nao_propriet direita esquerda m_absoluta, vce(robust)
	eststo R`i'
	local ++i
	
	regress `d_var' rend_mediano renda_med desemprego gini resid_estr esc_med_anos dens_pop sobrelot agreg_2 agreg_3 agreg_4 agreg_5 agreg_6 agreg_7 agreg_8 agreg_9_mais temp_med temp_amp lig_nec_rep med_nec_rep prof_nec_rep aloj_x_1919 aloj_1919_1945 aloj_1946_1960 aloj_1961_1980 aloj_1981_1990 aloj_1991_2000 aloj_2001_2005 aloj_2006_2010 aloj_2011_2015 propriet_c_enc nao_propriet direita esquerda m_absoluta, vce(robust)
	eststo R`i'
	local ++i
	...
	unicode convertfile "${user_directory}\stata\output\regressoes\temp_`d_var'.csv" "${user_directory}\stata\output\regressoes\desagregados_`d_var'.csv", dstencoding(Windows-1252) replace
