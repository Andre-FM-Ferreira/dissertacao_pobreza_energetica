* =============================================================================
* Regressões base - dados agregados
* =============================================================================
...
foreach d_var in "sim_mun" "sim_freg" {
	...
	unicode convertfile "${user_directory}\stata\output\regressoes\temp_`d_var'.csv" "${user_directory}\stata\output\regressoes\base_`d_var'.csv", dstencoding(Windows-1252) replace
